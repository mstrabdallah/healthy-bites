                            ...
                            <div class="CPaddress_content">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6   mt-4">
                                        <div >
                                        <label class="label_" for="fname">الاسم الاول</label>
                                            <input type="text" class="form-control custom-input input_" name="fname" value="" placeholder="ابراهيم" required>
                                        </div>
                                    </div>

                                    <div class="col-12 col-md-6   mt-4">
                                        <div >
                                            <label class="label_" for="lname">الاسم الاخير</label>
                                            <input type="text" class="form-control custom-input input_" name="lname" value="" placeholder="محمد" required>
                                        </div>
                                    </div>

                                    <div class="col-12 col-md-6   mt-4">
                                        <div class="form-group ">
                                            <label class="label_" for="email">البريد الالكتروني</label>
                                            <input type="email" class="form-control custom-input input_" name="email" value="" placeholder="ibhram@gail,.com" required>
                                        </div>
                                    </div>

                                    <div class="col-12 col-md-6  mt-4">
                                        <div class="form-group">
                                            <label class="label_" for="password">كلمة المرور</label>
                                            <input type="password" class="form-control custom-input input_" name="password" value="" placeholder="********" required>
                                        </div>
                                    </div>
</div>
                                    <div class="CPnexStep_">
                                        <button class="Save_btn">حفظ التعديلات</button>
                                    </div>
